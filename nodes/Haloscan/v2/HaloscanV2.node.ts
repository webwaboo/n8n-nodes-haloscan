...
export class HaloscanV2 implements INodeType {
	description: INodeTypeDescription = {
		...
		properties: [
			...
			// Additional Fields for getRankingOfDomainKeyword operation
			{
				displayName: 'Additional Fields',
			...
			// Additional Fields for getExpiredDomains operation
			{
				displayName: 'Additional Fields',
			...
			// Additional Fields for getDomainTopPages and getHistoryOfDomainPages operations
			{
				displayName: 'Additional Fields',
				name: 'additionalFields_getDomainTopPages_getHistoryOfDomainPages',
				type: 'collection',
				placeholder: 'Add Field',
				default: {},
				displayOptions: {
					show: {
						resource: ['siteExplorer'],
						operation: ['getDomainTopPages', 'getHistoryOfDomainPages'],
					},
				},
				options: [
					{
			...
			try {
				...
				// ==========================================
					...
					if (operation === 'compareDomainKeywordsWithCompetitors') {
						...
						const page = this.getNodeParameter('page', i, 1) as number;
						const orderBy = this.getNodeParameter('order_by_domain_history', i, 'default') as string;
						const additionalFieldsDomainTopPages = this.getNodeParameter('additionalFields_getDomainTopPages_getHistoryOfDomainPages', i, {}) as IDataObject;
						...
						responseData = await haloscanApiRequest.call(
							...
							'POST',
							'/domains/topPages',
							removeEmptyValues(mergeAdditionalFields(body, additionalFieldsDomainTopPages)),
						);
						...
						const additionalFieldsExpiredDomains = this.getNodeParameter('additionalFields_getExpiredDomains', i, {}) as IDataObject;
						...
						responseData = await haloscanApiRequest.call(
							...
							'POST',
							'/domains/expired',
							removeEmptyValues(mergeAdditionalFields(body, additionalFieldsExpiredDomains)),
						);
						...
						const additionalFieldsHistoryOfDomainPages = this.getNodeParameter('additionalFields_getDomainTopPages_getHistoryOfDomainPages', i, {}) as IDataObject;
						...
						responseData = await haloscanApiRequest.call(
							...
							removeEmptyValues(mergeAdditionalFields(body, additionalFieldsHistoryOfDomainPages)),
						);
						...
						const additionalFieldsRankingOfDomainKeyword = this.getNodeParameter('additionalFields_getRankingOfDomainKeyword', i, {}) as IDataObject;
						...
						responseData = await haloscanApiRequest.call(
							...
							'POST',
							'/domains/positions',
							removeEmptyValues(mergeAdditionalFields(body, additionalFieldsRankingOfDomainKeyword)),
						);
